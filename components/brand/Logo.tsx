...
export function Logo({ className = "w-8 h-8" }: LogoProps) {
  ...
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
      <ellipse cx="100" cy="120" rx="55" ry="65" fill={`url(#${bodyGradient})`} />

      <path d="M 55 110 Q 35 100 30 120 Q 35 140 50 145 Q 55 135 55 120 Z" fill={`url(#${wingGradient})`} />
      <path d="M 145 110 Q 165 100 170 120 Q 165 140 150 145 Q 145 135 145 120 Z" fill={`url(#${wingGradient})`} />

      <circle cx="100" cy="80" r="50" fill={`url(#${headGradient})`} />

      <path d="M 70 40 Q 65 25 75 35 Q 78 45 75 50 Z" fill={`url(#${bodyGradient})`} />
      <path d="M 130 40 Q 135 25 125 35 Q 122 45 125 50 Z" fill={`url(#${bodyGradient})`} />
      ...
      <ellipse cx="100" cy="140" rx="30" ry="35" fill={`url(#${chestGradient})`} opacity="0.3" />

      <path d="M 90 175 Q 85 185 90 190 Q 95 185 95 175 Z" fill={`url(#${wingGradient})`} opacity="0.6" />
      <path d="M 100 178 Q 95 188 100 193 Q 105 188 105 178 Z" fill={`url(#${wingGradient})`} opacity="0.6" />
      <path d="M 110 175 Q 105 185 110 190 Q 115 185 115 175 Z" fill={`url(#${wingGradient})`} opacity="0.6" />
...
export function LogoSimple({ className = "w-8 h-8" }: LogoProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
      ...
      <path d="M 55 110 Q 35 100 30 120 Q 35 140 50 145 Q 55 135 55 120 Z" fill="currentColor" />
      <path d="M 145 110 Q 165 100 170 120 Q 165 140 150 145 Q 145 135 145 120 Z" fill="currentColor" />
      <circle cx="100" cy="80" r="50" fill="currentColor" />
      <path d="M 70 40 Q 65 25 75 35 Q 78 45 75 50 Z" fill="currentColor" />
      <path d="M 130 40 Q 135 25 125 35 Q 122 45 125 50 Z" fill="currentColor" />
      <circle cx="85" cy="75" r="18" fill="white" />
      <circle cx="115" cy="75" r="18" fill="white" />
