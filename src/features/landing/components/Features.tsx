...
const features = [
  {
    ...
    description:
      "Create detailed study schedules and set realistic goals for each subject and topic.",
  ...
  },
  {
    ...
    title: "Time Tracking",
    description:
      "Log your actual study sessions and see exactly how much time you spend on each subject.",
  ...
  },
  {
    ...
    description:
      "Compare what you planned to study versus what you actually accomplished. Stay accountable.",
  ...
  },
  {
    ...
    description:
      "Visualize your learning progress with detailed charts, trends, and insights over time.",
  ...
  },
  {
    ...
    description:
      "Set and track short-term and long-term study goals. Measure your success rate.",
  ...
  },
  {
    ...
    description:
      "Connect with other students, share progress, and learn together in a focused community.",
  ...
  },
  {
    ...
    title: "Subjects Hub",
    description:
      "Centralize all subjects and topics in one structured place to keep your weekly study plan clear.",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="text-xl text-gray-600">
            From planning to tracking to analyzing, all the tools to take
