      ...
      <div className="section-shell grid gap-10 lg:grid-cols-2 lg:items-center">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft">
          <p className="text-sm font-semibold text-ink">
            Day/Week History (Mock)
          </p>
          <p className="mt-1 text-xs text-muted">
            Real study time trend over the last 7 days
          </p>
          ...
          <svg
            ...
            role="img"
            aria-label="Weekly real study time chart"
          >
            <line
              x1="22"
              y1="160"
          ...
          <div className="mt-4 rounded-2xl bg-slate-50 p-4 text-sm text-muted">
            Habit signal: You studied on 6 of 7 days and improved planned vs
            actual alignment across the week.
          </div>
        </div>
      </div>
    </section>
